    ...
    <div className="min-h-screen relative w-full flex justify-center items-center flex-col shadow-lg max-w-full overflow-x-hidden fade-in" id="presentation">
      ...
      <div className="relative flex justify-center items-center">
        <Image
          ...
          height={600}
          priority={true}
          className="w-full md:w-full animate-fade-in-up"
        />

        
        <div className="absolute top-14 transform flex justify-center animate-fade-in-up">
          <Image
            src="/yo.png"
            alt="profile image"
            width={150}
      ...
      <div className="relative text-center -mt-28 md:-mt-64 z-20 w-full md:px-4 px-20 max-w-md md:max-w-lg mx-auto animate-fade-in-up">
